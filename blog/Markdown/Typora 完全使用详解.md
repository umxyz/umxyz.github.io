...
![img](../#ImageAssets/49c4cdef47bf81018b9871a628523064-1587984045050.png)官网首页
...
![img](../#ImageAssets/a35f8fd5e9d968edfe5a0b02b54d0881-1587984045055.png)严格模式
...
![img](../#ImageAssets/ea30087c6f93d0fa3c5a313c8cdce357-1587984045061.jpg)文本编辑设置
...
![img](../#ImageAssets/1de13eae43785e27bbbcd631931fd161-1587984045066.png)复制图片

你也完全可以使用图床来保证文档在分享后图片仍能正常显示。

更强大的是，Typora 支持在拖动或 `Ctrl + V` 网络图片后自动将其保存到本地。你可以在 `文件 - 偏好设置 - 编辑器 - 图片插入` 中选择复制到哪个路径，什么情况下需要复制。

![img](../#ImageAssets/717da653ad91e938c5f1f40555b9c057.png)图片插入
...
![img](../#ImageAssets/8b4e14ef732a23d4cc2a8fb1f8ec016c-1587984045080.gif)两种模式
...
![img](../#ImageAssets/f99c9ce02e2728ec6c64b443947fc67e-1587984045095.gif)所见即所得

为了防止一些程序 bug 的发生（虽然在我使用下来感到是很少的）导致格式问题无法修改，Typora 保留了一个**「源代码模式」**。你可以通过 `视图 - 源代码模式` 或左下角的 `` 按钮进入。

![img](../#ImageAssets/bcda9c4e35725b7297a6b90d8745564e-1587984045095.gif)源代码模式

#### 大纲 / 文件侧边栏

![img](../#ImageAssets/f2461efb5ac297facfcd9f72cc5da6be-1587984045103.png)侧边栏
...
![img](../#ImageAssets/5c2fbaa53b27666a7fd0b07ac3e100bf-1587984045109.png)空格、换行、换段
...
![img](../#ImageAssets/b2601a694aba07b8a68615ca59bcc495-1587984045114.png)输入法联想

在 Typora 中，你可以用 `:emoji:` 的形式来打出 emoji，软件会自动给出图形的提示，还是比较好用的。

![img](../#ImageAssets/ff26eeb5ff2d6fae16cab163ebfcd096-1587984045120.png)Typora 中输入 emoji
...
![img](../#ImageAssets/a8c283ba4f1ba09d41331b87e2eef3b9-1587984045126.png)代码块
...
![img](../#ImageAssets/51bf2f290592e1ddbadb95765c04f297-1587984045131.png)Typora 表格
...
![img](../#ImageAssets/5f82606e6d89fe1eb24705c4ca6b895d-1587984045137.png)链接引用和脚注
...
![img](../#ImageAssets/ba295f21f0b71646bb36a0517e868ced-1587984045143.png)导出

## 一个伪装成文本编辑器的浏览器

当我的一个朋友问我「Typora 有什么好写的？」时，我回答「Typora 是一个伪装成文本编辑器的浏览器」。是的，事实上如果你有一定的计算机基础，你可以找到许多有关于「Typora 其实是一个浏览器」的蛛丝马迹。

![img](../#ImageAssets/13837bcdcded9ae406e8c4aac5f2d752-1587984045150.png)图片插入
...
![img](../#ImageAssets/da8c9b305a222cb5fadb41c12da81a12-1587984045155.png)审查元素
...
![img](../#ImageAssets/7ce3d9ed245eed902e833405b9464103-1587984045161.jpg)数字油画

#### HTML 标签

Typora 支持许多常用的 HTML 标签，如果你了解 HTML 语法的话，你可以写出十分美观丰富的文档页面。

![img](../#ImageAssets/89bba4dfdfb49b8d3c129ce1157a54b1-1587984045170.png)HTML 标签
...
![img](../#ImageAssets/3d818c18934632b043fcf4ad9be1d046.png)公众号
...
![img](../#ImageAssets/7d3cfbc92721733e16ed63d72a48a572-1587984045178.png)主题

![img](../#ImageAssets/98a04c4f9129e0f018d15bc790b376c2-1587984045185.png)主题文件夹

选择不同的主题可以使文档拥有不同的外观，但不会影响内容。Typora 自带了若干主题，你也可以在 [官网](http://theme.typora.io/) 下载更多的主题。

![img](../#ImageAssets/efcf65ba993c4bb0b058d6eb8258df6f-1587984045190.png)主题商店
...
![img](../#ImageAssets/317ac1df25fcfc817c03f92d6086764e-1587984045196.png)CSS 文件
